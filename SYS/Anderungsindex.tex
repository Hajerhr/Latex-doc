...
\begin{tabular}{wc{1.4cm} | wc{2.3cm} | wc{2.5cm} | wl{9.8cm}}
\xrowht{15pt}

\fontfamily{phv}\selectfont\textbf{Version} &
\fontfamily{phv}\selectfont\textbf{Datum} & 
\fontfamily{phv}\selectfont\textbf{Verfasser} & 
\fontfamily{phv}\selectfont\textbf{Änderungen}\\ \hline \xrowht{10pt}

\multirow{3}{*}{\fontfamily{phv}\selectfont{14}} &
\multirow{3}{*}{\fontfamily{phv}\selectfont{15.03.2020}} &
\fontfamily{phv}\selectfont{M. Strohrmann,} &
\multirow{2}{*}{\fontfamily{phv}\selectfont{Korrektur von Fehlern, insbesondere bei Anfangs- und }}\\ \xrowht{8pt}

&
&
\fontfamily{phv}\selectfont{F. Keller,} &
\multirow{2}{*}{\fontfamily{phv}\selectfont{Übergangsbedingungen}}
\\  \xrowht{8pt}
&
&
\fontfamily{phv}\selectfont{J. Weizenecker} &
\\ \hline \xrowht{8pt}

\multirow{2}{*}{\fontfamily{phv}\selectfont{13}} &
\multirow{2}{*}{\fontfamily{phv}\selectfont{15.03.2017}} &
\fontfamily{phv}\selectfont{M. Strohrmann,} &
\multirow{2}{*}{\fontfamily{phv}\selectfont{Korrektur von Fehlern}}\\ \xrowht{10pt}
...
\multirow{2}{*}{\fontfamily{phv}\selectfont{15.03.2016}} &
\fontfamily{phv}\selectfont{M. Strohrmann,} &
\multirow{2}{*}{\fontfamily{phv}\selectfont{Ausgabe für Systemtheorie Online}}\\ \xrowht{10pt}
